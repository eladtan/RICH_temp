...
See [Equations of State](Equations-of-State) for other options.
...
Instead of hardcoding parameters, read them from text files at runtime:
...
This pattern allows the same binary to run different configurations without recompilation.
