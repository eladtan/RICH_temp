#!/usr/bin/env python3
"""
Overlay 512, 512-limited, 32, and 32-limited free-free diffusion profiles.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Overlay free-free diffusion profiles for 512, 512-limited, 32, and 32-limited cells.")
    ...
    ax.set_title("Free-free diffusion: Tgas(x), 512/512 limited/32/32 limited")
    ax.set_yscale("log")
    ax.grid(True, alpha=0.3)
    ax.legend()
    fig.tight_layout()
    tgas_png = os.path.join(args.output_dir, "temperature_vs_x_compare_512_512_limited_32_32_limited.png")
    tgas_pdf = os.path.join(args.output_dir, "temperature_vs_x_compare_512_512_limited_32_32_limited.pdf")
    ...
    ax.set_title("Free-free diffusion: Trad(x), 512/512 limited/32/32 limited")
    ax.set_yscale("log")
    ax.grid(True, alpha=0.3)
    ax.legend()
    fig.tight_layout()
    trad_png = os.path.join(args.output_dir, "trad_vs_x_compare_512_512_limited_32_32_limited.png")
    trad_pdf = os.path.join(args.output_dir, "trad_vs_x_compare_512_512_limited_32_32_limited.pdf")
    ...
    ax.set_title("Free-free diffusion: density(x), 512/512 limited/32/32 limited")
    ax.set_yscale("log")
    ax.grid(True, alpha=0.3)
    ax.legend()
    fig.tight_layout()
    density_png = os.path.join(args.output_dir, "density_vs_x_compare_512_512_limited_32_32_limited.png")
    density_pdf = os.path.join(args.output_dir, "density_vs_x_compare_512_512_limited_32_32_limited.pdf")
    ...
    ax.set_title("Free-free diffusion: vx(x), 512/512 limited/32/32 limited")
    ax.grid(True, alpha=0.3)
    ax.legend()
    fig.tight_layout()
    velocity_png = os.path.join(args.output_dir, "velocity_vs_x_compare_512_512_limited_32_32_limited.png")
    velocity_pdf = os.path.join(args.output_dir, "velocity_vs_x_compare_512_512_limited_32_32_limited.pdf")
