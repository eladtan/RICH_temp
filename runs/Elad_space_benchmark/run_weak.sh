...
ln -s space_${SLURM_JOB_ID}_run.out space_WS_${SLURM_JOB_ID}_n${SLURM_NTASKS}.out
ln -s space_${SLURM_JOB_ID}_run.err space_WS_${SLURM_JOB_ID}_n${SLURM_NTASKS}.err
