...
#SBATCH --job-name="Space3D-P2P-StrongScale"
...
ln -s space_${SLURM_JOB_ID}_run.out space_SS_P2P_${SLURM_JOB_ID}_n${SLURM_NTASKS}.out
ln -s space_${SLURM_JOB_ID}_run.err space_SS_P2P_${SLURM_JOB_ID}_n${SLURM_NTASKS}.err
...
echo "P2P strong scaling parameters:"
...
ARGS="${NBASE} ${N_EMIT} ${CYCLES} --dt ${DT} --p2p"
EXEC="./rich"
