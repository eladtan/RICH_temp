...
#SBATCH --output=/home/maorm/RICH/runs/RMTV/verification/bigrun_n48_tau3_%j.out
#SBATCH --error=/home/maorm/RICH/runs/RMTV/verification/bigrun_n48_tau3_%j.err
...
rmtv_output="$rmtv_dir/verification/convergence_n48_tau3_bigrun_${SLURM_JOB_ID}"
cd "$rmtv_dir"
