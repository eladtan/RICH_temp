...
#SBATCH --output=/home/maorm/RICH/runs/RMTV/verification/bigrun_n96_%j.out
#SBATCH --error=/home/maorm/RICH/runs/RMTV/verification/bigrun_n96_%j.err
...
rmtv_output="$rmtv_dir/verification/convergence_n96_bigrun_${SLURM_JOB_ID}"
cd "$rmtv_dir"
