...
#SBATCH --output=/home/maorm/RICH/runs/RMTV/verification/bigrun_n96_v3_%j.out
#SBATCH --error=/home/maorm/RICH/runs/RMTV/verification/bigrun_n96_v3_%j.err
...
rmtv_output="$rmtv_dir/verification/convergence_n96_v3_bigrun_${SLURM_JOB_ID}"
cd "$rmtv_dir"
...
"$rmtv_mpirun" -np "$SLURM_NTASKS" --bind-to core "$rmtv_bin" \
    --octant --n 96 --quadrature 8 --dt-fraction .005 \
    --photons 16 --initial-photons 16 --max-photons 32 --dump 100 --ddmc-min-tau 3 --lb-interval 1 \
    --output "$rmtv_output"
