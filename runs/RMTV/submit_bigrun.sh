...
#SBATCH --output=/home/maorm/RICH/runs/RMTV/verification/bigrun_%j.out
#SBATCH --error=/home/maorm/RICH/runs/RMTV/verification/bigrun_%j.err
...
rmtv_bin=/home/maorm/RICH/build/gnuReleaseMPI/RMTV/rich
rmtv_mpirun=/software/x86_64/5.14.0/openmpi/4.1.6/gcc/12.3.0/bin/mpirun
rmtv_output="$rmtv_dir/verification/convergence_n32_bigrun_${SLURM_JOB_ID}"
cd "$rmtv_dir"
...
"$rmtv_mpirun" -np "$SLURM_NTASKS" --bind-to core "$rmtv_bin" \
    --octant --n 32 --quadrature 8 --dt-fraction .005 \
