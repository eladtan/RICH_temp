#!/usr/bin/env bash
#SBATCH --job-name=RMTV_n48_drain
...
#SBATCH --output=/home/maorm/RICH/runs/RMTV/verification/bigrun_n48_drain_%j.out
#SBATCH --error=/home/maorm/RICH/runs/RMTV/verification/bigrun_n48_drain_%j.err
...
rmtv_output="$rmtv_dir/verification/convergence_n48_drain_bigrun_${SLURM_JOB_ID}"
cd "$rmtv_dir"
