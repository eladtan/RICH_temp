...
logfile = outdir.parent / 'densmore_mc_9804763.out'
rw_elapsed, norw_elapsed, rw_steps, norw_steps, rw_rwsteps = parse_log(logfile)

snap_pairs = [
    ('densmore_step_mc_rw_00020.txt', 'densmore_step_mc_norw_00020.txt', 't = 0.1 ns'),
    ('densmore_step_mc_rw_00100.txt', 'densmore_step_mc_norw_00100.txt', 't = 0.5 ns'),
    ('densmore_step_mc_rw_final.txt',  'densmore_step_mc_norw_final.txt',  't = 1.0 ns (final)'),
]
...
xr, Tr = load_profile('densmore_step_mc_rw_final.txt')
xn, Tn = load_profile('densmore_step_mc_norw_final.txt')
