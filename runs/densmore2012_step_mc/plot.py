...
def main():
    ...
    ax1.set_title('Densmore 2012 Step — MC Multigroup')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'densmore_mc_profiles.png'), dpi=150)
    print(f"Saved {os.path.join(output_dir, 'densmore_mc_profiles.png')}")
    plt.show()
