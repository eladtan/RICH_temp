...
int main(void)
{
	...
	MultigroupDiffusion matrix_builder(energy_groups_center, energy_groups_boundary, opacity, D_boundary, eos, std::vector<std::string> (), /*flux_limiter*/false, false, false);
