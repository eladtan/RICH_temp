 ...
 *
 * Outputs densmore2012_mc_profile.txt (x, T_K) for comparison with the
 * digitized Monte Carlo curve from Figure 4 of the paper.
 */

 #if ENERGY_GROUPS_NUM != 32
 #error "ENERGY_GROUPS_NUM must be 32 for this test"
 #endif
...
int main(int argc, char *argv[])
{
  ...
  try
  {
    ...
    if(rank == 0)
    {
        ...
        std::string const profilePath = outputDir + "/densmore2012_mc_profile.txt";
