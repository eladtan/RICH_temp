...
Vector2D StaticVoronoiMesh::CalcFaceVelocity(Vector2D const& wl, Vector2D const& wr,Vector2D const& rL, Vector2D const& rR,
...
void StaticVoronoiMesh::GetBorderingCells(vector<int> const& copied,
