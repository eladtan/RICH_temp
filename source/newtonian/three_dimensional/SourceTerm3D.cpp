...
void ZeroForce3D::operator()(const Tessellation3D& /*tess*/, const vector<ComputationalCell3D>& /*cells*/,
		...
		double /*dt*/, vector<Conserved3D> &/*extensives*/, const vector<Vector3D> & /*ustar_vec*/, const std::vector<std::pair<ComputationalCell3D, ComputationalCell3D> > & /*face_values*/) const {} 
