...
void GetPlanes(vector<r3d_plane> &res, Tessellation3D const& tess, size_t index, bool const print = false);
...
std::pair<bool, std::array<double,4> > PolyhedraIntersection(Tessellation3D const& newtess, size_t newcell,r3d_poly &poly,
	vector<r3d_plane> *planes = nullptr, bool const print = false);
