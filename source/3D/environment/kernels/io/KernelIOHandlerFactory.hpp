...
namespace KernelIO
{
    ...
    inline void writeKernel(HDF5Writer &writer, const std::string &group, const Kernelization3D::IndexingKernel3D &kernel)
    {
    ...
    inline std::shared_ptr<Kernelization3D::IndexingKernel3D> readKernel(const HDF5Reader &reader, const std::string &group)
    {
        std::string name;
