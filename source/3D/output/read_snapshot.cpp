...
Snapshot3D ReadSnapshot3DHelper(H5File &file, H5File &globalfile, Group &read_location)
{
    Snapshot3D res;
    // Mesh points
    {
...
)
{
    ...
    Snapshot3D res = ReadSnapshot3DHelper(file, file, read_location);
...
Snapshot3D ReadSnapshot3DParallel(const string &fname, int fake_rank)
{
    ...
    Snapshot3D res = ReadSnapshot3DHelper(file, globalfile, read_location);
