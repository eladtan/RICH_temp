...
if(DEFINED MPI)
    ...
    add_definitions("-DSTORM_WITH_MPI")
    add_definitions("-DMADVORO_WITH_MPI")
    add_definitions("-DSPATIAL_DS_WITH_MPI")
    message(STATUS "Defined 'RICH_MPI', '__WITH_MPI', 'STORM_WITH_MPI', 'MADVORO_WITH_MPI', and 'SPATIAL_DS_WITH_MPI'")
endif()
