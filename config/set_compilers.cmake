set(GNU_MPI_CC_NAME "mpicc")
set(GNU_MPI_CXX_NAME "mpicxx")
set(GNU_MPI_Fortran_NAME "mpif90")
set(INTEL_MPI_CC_NAME "mpiicx")
set(INTEL_MPI_CXX_NAME "mpiicpx")
set(INTEL_MPI_Fortran_NAME "mpiifx")
set(GNU_CC_NAME "gcc")
set(GNU_CXX_NAME "g++")
...
if(DEFINED MPI)
    if(DEFINED GNU)
        ...
        find_executable_path(${GNU_MPI_CC_NAME} CMAKE_C_COMPILER)
        find_executable_path(${GNU_MPI_CXX_NAME} CMAKE_CXX_COMPILER)
        find_executable_path(${GNU_MPI_Fortran_NAME} CMAKE_Fortran_COMPILER)
    endif()
    if(DEFINED INTEL)
        message(STATUS "Intel, MPI")
        find_executable_path(${INTEL_MPI_CC_NAME} CMAKE_C_COMPILER)
        find_executable_path(${INTEL_MPI_CXX_NAME} CMAKE_CXX_COMPILER)
        find_executable_path(${INTEL_MPI_Fortran_NAME} CMAKE_Fortran_COMPILER)
    endif()
else()
    if(DEFINED GNU)
