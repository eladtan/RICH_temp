...
To use multigroup diffusion with tabulated opacities, implement the `MultigroupDiffusionCoefficientCalculator` interface. A tabulated implementation can load STA opacity tables:
