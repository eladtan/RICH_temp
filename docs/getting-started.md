...
- [Build System](build-system.md) -- detailed build options and configurations
- [Running Simulations](running-simulations.md) -- serial, MPI, and SLURM execution
- [Simulation Setup](user-guide/simulation-setup.md) -- how to write your own `main.cpp`
- [Examples](examples/sod-shock-tube.md) -- step-by-step walkthroughs
